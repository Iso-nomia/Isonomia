 ...
 * advertised schema). */
export const DELIBERATION_SCOPED_TOOLS: ReadonlySet<string> = new Set([
  "list_behaviours",
...
export const WEBMCP_BACKING_TOOLS: ReadonlySet<string> = new Set([
...
export const COMMITMENT_MUTATING_MOVE_KINDS: ReadonlySet<string> = new Set([
  "CONCEDE",
  "ACCEPT",
  "RETRACT",
  "CLOSE",
